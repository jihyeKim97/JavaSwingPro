...
//		this.dbc2 = new Login_DB();
		...
		lb_userJoin.setBounds(0, 10, 521, 43);
		lb_userJoin.setFont(new Font("맑은 고딕 Semilight", Font.BOLD, 31));
		lb_userJoin.setVerticalAlignment(SwingConstants.TOP);
		contentPane.add(lb_userJoin);

		JPanel panel = new JPanel();
		panel.setBounds(-24, 67, 444, 268);
...
//				if(ke.getKeyChar())
		...
		btn_DupCheck.setFont(new Font("맑은 고딕 Semilight", Font.PLAIN, 9));
		btn_DupCheck.setBounds(429, 74, 68, 29);
		...
		btn_cancel.setBounds(188, 345, 136, 50);
		...
		btn_userJoin.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				// 회원가입 DB
				// insertNewMember(String UserId, String UserPw, String UserName, int Gender,
				// Date UserDoB,
//				String UserEmail, int UserPhoneNum)
		...
		btn_userJoin.setBounds(349, 345, 136, 50);
