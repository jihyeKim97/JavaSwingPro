...
public class MyPage_Reservation extends JFrame {
	...
	public MyPage_Reservation() {
		...
		lb_UserInformation.setFont(new Font("±º∏≤", Font.PLAIN, 16));
		...
		lb_ReservaitonTitle.setFont(new Font("±º∏≤", Font.BOLD, 20));
		...
		btn_UserImfomation.setFont(new Font("±º∏≤", Font.PLAIN, 12));
		...
		btn_UserReservaution.setFont(new Font("±º∏≤", Font.PLAIN, 12));
		...
		btn_Review.setFont(new Font("±º∏≤", Font.PLAIN, 12));
		...
		btn_ReservationCancle.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showConfirmDialog(null, "øπ∏≈∏¶ √Îº“«œΩ√∞⁄Ω¿¥œ±Ó?", "øπ∏≈√Îº“", JOptionPane.YES_NO_OPTION , JOptionPane.PLAIN_MESSAGE);
			}
		});
