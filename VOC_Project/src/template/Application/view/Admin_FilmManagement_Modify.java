...
public class Admin_FilmManagement_Modify extends JDialog {
	...
	Admin_FilmManagement_Modify dlg;
	String dbImgPath;
	String ppp;
	JLabel ad_lb_poster;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Admin_FilmManagement_Modify window = new Admin_FilmManagement_Modify();
	 ...
	 */
	public Admin_FilmManagement_Modify() {
		initialize();
	}
	...
	private void initialize() {
		...
		image1 = new ImageIcon("./src"+MyArr.get(0).getImage_file_name());
		...
		btnDown.setBounds(7, 707, 107, 48);
		panel.add(btnDown);
	}
}
